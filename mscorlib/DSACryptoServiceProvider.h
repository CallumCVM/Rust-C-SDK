...
#include "..\Mono\Security\Cryptography\DSAManaged.h"
...
{
	class DSACryptoServiceProvider : public DSA // 0x20
	{
	public:
		...
		Mono::Security::Cryptography::DSAManaged* dsa; // 0x30 (size: 0x8, flags: 0x1, type: 0x12)
	}; // size = 0x38
}
